...
This project is inspired by and based on the hardware architecture of the **Thyme** delay processor by **Bastl Instruments**. Huge thanks to the Bastl team for their innovative designs and for inspiring the exploratory spirit of this plugin.

For more information about the original hardware, visit [Bastl Instruments](https://bastl-instruments.com/).

## License

This project is licensed under the **Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)** - see the [LICENSE](LICENSE) file for details.
